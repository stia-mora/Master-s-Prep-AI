...
from master_prep_ai.core.trace import derive_trace_metadata, merge_trace_metadata, new_call_id
...
class DeepResearchCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        from master_prep_ai.agents.research.research_pipeline import ResearchPipeline
        from master_prep_ai.capabilities._answer_now import extract_answer_now_context
        from master_prep_ai.services.config import load_config_with_main
