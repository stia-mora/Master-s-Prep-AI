...
from master_prep_ai.core.trace import merge_trace_metadata
...
class VisualizeCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from master_prep_ai.agents.visualize.pipeline import VisualizePipeline
        from master_prep_ai.agents.visualize.utils import (
            build_fallback_html,
        ...
        async with stream.stage("reviewing", source=self.name):
            if analysis.render_type == "html":
                ...
                from master_prep_ai.agents.visualize.models import ReviewResult
