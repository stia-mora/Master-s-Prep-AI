...
Unified configuration loading for all Master Prep AI modules.
...
# PROJECT_ROOT points to the actual project root directory (Master Prep AI/)
# Path(__file__) = master_prep_ai/services/config/loader.py
# .parent = master_prep_ai/services/config/
# .parent.parent = master_prep_ai/services/
# .parent.parent.parent = master_prep_ai/
# .parent.parent.parent.parent = Master Prep AI/ (project root)
