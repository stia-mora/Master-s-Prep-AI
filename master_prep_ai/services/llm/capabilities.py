...
Usage:
    from master_prep_ai.services.llm.capabilities import get_capability, supports_response_format
...
MODEL_OVERRIDES: dict[str, dict[str, object]] = {
    ...
    # See: https://github.com/3171381144/Master-s-Prep-AI/issues/141
    "gpt-5": {
