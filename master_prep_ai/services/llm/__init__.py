...
Unified LLM service for all Master Prep AI modules.
...
Usage:
    ...
    from master_prep_ai.services.llm import complete, stream
    ...
    # Configuration
    from master_prep_ai.services.llm import get_llm_config, LLMConfig
    config = get_llm_config()

    # URL utilities for local LLM servers
    from master_prep_ai.services.llm import sanitize_url, is_local_llm_server
"""
...
def __getattr__(name: str):
    ...
    if name == "cloud_provider":
        return import_module("master_prep_ai.services.llm.cloud_provider")
    if name == "local_provider":
        return import_module("master_prep_ai.services.llm.local_provider")
