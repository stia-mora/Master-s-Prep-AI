...
from master_prep_ai.services.llm.provider_core.openai_compat_provider import OpenAICompatProvider
from master_prep_ai.services.provider_registry import find_by_name
