...
from master_prep_ai.services.llm.capabilities import disable_response_format_at_runtime
from master_prep_ai.services.llm.provider_core.base import LLMProvider, LLMResponse, ToolCallRequest
from master_prep_ai.services.llm.provider_core.openai_responses import (
    consume_sdk_stream,
    convert_messages,
    convert_tools,
...
if TYPE_CHECKING:
    from master_prep_ai.services.provider_registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/3171381144/Master-s-Prep-AI",
    "X-OpenRouter-Title": "Master Prep AI",
}
