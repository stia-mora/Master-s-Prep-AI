...
class TutorBotManager:
    ...
    def _shared_memory_dir(self) -> Path:
        """Public memory shared by Master Prep AI and all bots."""
    ...
    async def start_bot(self, bot_id: str, config: BotConfig | None = None) -> TutorBotInstance:
        ...
        # -- Heartbeat --------------------------------------------------------
        from master_prep_ai.tutorbot.heartbeat import HeartbeatService
    ...
    async def _outbound_router(self, bot_id: str, bus: Any, instance: TutorBotInstance) -> None:
        ...
        """
        try:
            from master_prep_ai.events.event_bus import Event, EventType, get_event_bus
            from master_prep_ai.tutorbot.bus.events import OutboundMessage as _OMsg
    ...
    def _build_channel_manager(
        ...
        *,
        ...
        from master_prep_ai.tutorbot.config.schema import ChannelsConfig
