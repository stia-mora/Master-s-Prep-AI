...
class TurnRuntimeManager:
    ...
    async def start_turn(self, payload: dict[str, Any]) -> tuple[dict[str, Any], dict[str, Any]]:
        ...
        try:
            from master_prep_ai.capabilities.request_contracts import validate_capability_config
    ...
    async def _run_turn(self, execution: _TurnExecution) -> None:
        ...
        try:
            from master_prep_ai.agents.notebook import NotebookAnalysisAgent
            ...
            from master_prep_ai.services.memory import get_memory_service
            from master_prep_ai.services.notebook import notebook_manager
            from master_prep_ai.services.session.context_builder import ContextBuilder
            from master_prep_ai.services.skill import get_skill_service
            ...
            from master_prep_ai.services.storage import get_attachment_store
            ...
            from master_prep_ai.utils.document_extractor import extract_documents_from_records
