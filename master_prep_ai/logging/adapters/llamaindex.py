...
Forwards LlamaIndex logs to Master Prep AI's unified logging system.
"""
...
class LlamaIndexLogForwarder(logging.Handler):
    """
    Handler that forwards LlamaIndex logger messages to Master Prep AI logger.
    """

    def __init__(self, ai_tutor_logger, add_prefix: bool = True):
        """
        Args:
            ai_tutor_logger: Master Prep AI Logger instance
    ...
    def emit(self, record: logging.LogRecord):
        """
        Forward log record to Master Prep AI logger.
        """
        try:
