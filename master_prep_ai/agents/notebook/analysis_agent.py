...
from master_prep_ai.core.trace import build_trace_metadata, derive_trace_metadata, new_call_id
from master_prep_ai.services.llm import clean_thinking_tags, get_llm_config, get_token_limit_kwargs
from master_prep_ai.services.llm import stream as llm_stream
from master_prep_ai.services.prompt.manager import get_prompt_manager
...
class NotebookAnalysisAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts come from master_prep_ai/agents/notebook/prompts/{en,zh}/analysis_agent.yaml
