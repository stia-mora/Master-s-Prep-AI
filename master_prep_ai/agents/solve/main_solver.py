...
from master_prep_ai.core.trace import derive_trace_metadata, new_call_id
...
class MainSolver:
    ...
    async def _load_config(self) -> None:
        ...
        from master_prep_ai.services.llm import is_local_llm_server
    ...
    def _init_logging(self) -> None:
        ...
        from master_prep_ai.logging import Logger
