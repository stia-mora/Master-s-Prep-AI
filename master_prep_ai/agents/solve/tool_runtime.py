...
from master_prep_ai.runtime.registry.tool_registry import ToolRegistry as CoreToolRegistry
...
class SolveToolRuntime:
    ...
    async def execute(
        ...
        *,
        ...
        from master_prep_ai.core.tool_protocol import ToolResult as _ToolResult
