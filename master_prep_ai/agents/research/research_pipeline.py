...
from master_prep_ai.agents.research.agents import (
    DecomposeAgent,
    ManagerAgent,
    NoteAgent,
    RephraseAgent,
...
from master_prep_ai.agents.research.data_structures import DynamicTopicQueue
from master_prep_ai.agents.research.utils.citation_manager import CitationManager
from master_prep_ai.core.trace import new_call_id
...
class ResearchPipeline:
    ...
    async def run(self, topic: str) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                from master_prep_ai.agents.research.utils.token_tracker import get_token_tracker
    ...
    async def _phase2_researching_parallel(self):
        ...
        from master_prep_ai.agents.research.data_structures import TopicStatus
