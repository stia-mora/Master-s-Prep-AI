...
from master_prep_ai.tools.prompting import load_prompt_hints
...
class BrainstormTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from master_prep_ai.tools.brainstorm import brainstorm
...
class WebSearchTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from master_prep_ai.tools.web_search import web_search
...
"""
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from master_prep_ai.tools.code_executor import run_code
    ...
    async def _generate_code(self, intent: str) -> str:
        from master_prep_ai.services.llm import complete, get_token_limit_kwargs
...
class ReasonTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from master_prep_ai.tools.reason import reason
...
class PaperSearchToolWrapper(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from master_prep_ai.tools.paper_search_tool import ArxivSearchTool
...
class GeoGebraAnalysisTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from master_prep_ai.agents.vision_solver.vision_solver_agent import VisionSolverAgent
        from master_prep_ai.services.llm.config import get_llm_config
