...
from master_prep_ai.tutorbot.agent.tools.registry import build_base_tools
from master_prep_ai.tutorbot.bus.events import OutboundMessage
...
from master_prep_ai.tutorbot.utils.helpers import (
    ensure_dir,
    parse_json_from_llm,
    safe_filename,
    timestamp,
...
if TYPE_CHECKING:
    from master_prep_ai.tutorbot.agent.tools.registry import ToolRegistry
