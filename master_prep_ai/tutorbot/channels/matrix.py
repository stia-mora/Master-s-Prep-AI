...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install master_prep_ai[matrix]"
    ) from e
...
from master_prep_ai.tutorbot.config.paths import get_data_dir, get_media_dir
from master_prep_ai.tutorbot.config.schema import Base
from master_prep_ai.tutorbot.utils.helpers import safe_filename
