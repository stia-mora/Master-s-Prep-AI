...
from master_prep_ai.tutorbot.providers.base import LLMProvider, LLMResponse, ToolCallRequest

if TYPE_CHECKING:
    from master_prep_ai.tutorbot.providers.registry import ProviderSpec
