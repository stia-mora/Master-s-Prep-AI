...
class ProgressTracker:
    ...
    def _notify(self, progress: dict):
        ...
        from master_prep_ai.runtime.mode import is_server
    ...
    def update(
        ...
        try:
            ...
            fallback_logger = logging.getLogger("master_prep_ai.ProgressTracker")
            prefix = f"[{self.task_id}]" if self.task_id else ""
        ...
        if self.task_id:
            try:
                from master_prep_ai.api.utils.task_log_stream import get_task_stream_manager
