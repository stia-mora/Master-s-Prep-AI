...
Why live here vs inside ``master_prep_ai.tutorbot.channels``?
...
from master_prep_ai.services.tutorbot.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    from master_prep_ai.tutorbot.channels.registry import discover_all
