...
from master_prep_ai.services.config import resolve_search_runtime_config
...
from master_prep_ai.services.llm import get_llm_config, get_token_limit_kwargs
...
async def test_search_connection():
    ...
    try:
        ...
        result = web_search("Master Prep AI health check", provider=search_config.provider)
        response_time = (time.time() - start_time) * 1000
