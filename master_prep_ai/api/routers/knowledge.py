...
from master_prep_ai.api.utils.progress_broadcaster import ProgressBroadcaster
from master_prep_ai.api.utils.task_id_manager import TaskIDManager
from master_prep_ai.api.utils.task_log_stream import capture_task_logs, get_task_stream_manager
...
from master_prep_ai.services.config import PROJECT_ROOT, load_config_with_main
from master_prep_ai.services.rag.factory import DEFAULT_PROVIDER
...
from master_prep_ai.utils.error_utils import format_exception_message
...
async def get_all_kb_configs():
    ...
    try:
        from master_prep_ai.services.config import get_kb_config_service
...
async def reindex_knowledge_base(
    ...
    try:
        ...
        from master_prep_ai.services.rag.embedding_signature import signature_from_embedding_config
...
async def websocket_progress(websocket: WebSocket, kb_name: str):
    ...
    from master_prep_ai.auth import require_websocket_user
    ...
    try:
        ...
        kb_dir = _kb_base_dir / kb_name
        from master_prep_ai.services.rag.index_versioning import list_kb_versions
