...
from master_prep_ai.services.config import get_config_test_runner, get_model_catalog_service
...
def _provider_choices() -> dict[str, list[dict[str, str]]]:
    ...
    from master_prep_ai.services.provider_registry import PROVIDERS
...
async def complete_tour(payload: TourCompletePayload | None = None):
    ...
    return {
        "status": "completed",
        "message": "Configuration saved. Master Prep AI will restart shortly.",
        "launch_at": launch_at,
