...
Reuses:
- ``master_prep_ai.services.session.get_sqlite_session_store`` for chat history
- ``master_prep_ai.services.notebook.notebook_manager`` for notebook records
- ``master_prep_ai.agents.notebook.NotebookAnalysisAgent`` for context distillation
"""
