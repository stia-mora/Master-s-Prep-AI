...
class MasterPrepAIError(Exception):
    """Base class for all application errors in Master Prep AI."""
...
class ConfigurationError(MasterPrepAIError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(MasterPrepAIError):
    """Raised when input validation fails."""

    pass


class ServiceError(MasterPrepAIError):
