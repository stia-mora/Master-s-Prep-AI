"""Stable application-layer facade for Master Prep AI entry points."""
...
from master_prep_ai.services.notebook import get_notebook_manager
from master_prep_ai.services.session import get_sqlite_session_store, get_turn_runtime_manager
