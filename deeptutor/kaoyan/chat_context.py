"""Build DeepTutor chat/RAG context from kaoyan content records."""
...
First use RAG retrieval on this selected knowledge base, then explain with DeepTutor style: intuition first, then definition/formula, then typical problem patterns, then 2-3 self-check questions.
Suggested retrieval query: {query}
"""
