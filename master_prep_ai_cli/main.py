"""CLI entry point for the standalone ``master_prep_ai-cli`` package."""

from __future__ import annotations

import typer

from master_prep_ai.runtime.mode import RunMode, set_mode
from master_prep_ai.services.setup import get_backend_port
...
app = typer.Typer(
    name="master_prep_ai",
    help="Master Prep AI CLI – agent-first interface for capabilities, tools, and knowledge.",
...
def run_capability(
    ...
    maybe_run(run_turn_and_render(app=MasterPrepAIApp(), request=request, fmt=fmt))
