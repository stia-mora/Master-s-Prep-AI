...
from master_prep_ai.app import MasterPrepAIApp, TurnRequest
...
def register(app: typer.Typer) -> None:
    ...
    def chat(
        ...
        """Enter interactive chat REPL. Use `master_prep_ai run` for single-turn execution."""
