...
import { createDiagnosticSession, createKaoyanChatContext, createPracticePdf, createPracticeSession, downloadPracticePdf as downloadPracticePdfBlob, generatePlan, getDashboardSummary, getDiagnosticReports, confirmDiagnosticReport, getKnowledgeDetail, getKnowledgeTree, getReviewsToday, getTodayTasks, getWrongQuestions, initProfile, submitDiagnostic, submitPractice, submitReview, updateTaskStatus } from "@/lib/kaoyan-api";
import type { ContentQuestion, DashboardSummary, DiagnosticReport, DiagnosticResult, KaoyanProfile, KnowledgeDetail, KnowledgeNode, PlanTask, PracticePdfPayload, PracticeResult, PracticeSession, ProfileDraft, ReviewItem, WrongQuestion } from "@/lib/kaoyan-types";
